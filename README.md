...
[![PkgGoDev](https://pkg.go.dev/badge/github.com/d-enk/go-yaml)](https://pkg.go.dev/github.com/d-enk/go-yaml)
![Go](https://github.com/d-enk/go-yaml/workflows/Go/badge.svg)
[![codecov](https://codecov.io/gh/goccy/go-yaml/branch/master/graph/badge.svg)](https://codecov.io/gh/goccy/go-yaml)
[![Go Report Card](https://goreportcard.com/badge/github.com/d-enk/go-yaml)](https://goreportcard.com/report/github.com/d-enk/go-yaml)
...
- A better parser than `go-yaml/yaml`. 
  ...
  - Higher coverage in the [YAML Test Suite](https://github.com/yaml/yaml-test-suite?tab=readme-ov-file)
    ...
    - The test code is [here](https://github.com/d-enk/go-yaml/blob/master/yaml_test_suite_test.go#L77)
...
- An API structure that allows the use of not only `Encoder`/`Decoder` but also `Tokenizer` and `Parser` functionalities.
  - [lexer.Tokenize](https://pkg.go.dev/github.com/d-enk/go-yaml@v1.15.4/lexer#Tokenize)
  - [parser.Parse](https://pkg.go.dev/github.com/d-enk/go-yaml@v1.15.4/parser#Parse)
...
- Customize the Marshal/Unmarshal behavior for primitive types and third-party library types ([RegisterCustomMarshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#RegisterCustomMarshaler), [RegisterCustomUnmarshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#RegisterCustomUnmarshaler))
- Respects `encoding/json` behavior
  ...
  - [json.Marshaler](https://pkg.go.dev/encoding/json#Marshaler) style [marshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#BytesMarshaler)
  - [json.Unmarshaler](https://pkg.go.dev/encoding/json#Unmarshaler) style [unmarshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#BytesUnmarshaler)
  - Options for using `MarshalJSON` and `UnmarshalJSON` ([UseJSONMarshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#UseJSONMarshaler), [UseJSONUnmarshaler](https://pkg.go.dev/github.com/d-enk/go-yaml#UseJSONUnmarshaler))
- Pretty format for error notifications
- Smart validation processing combined with [go-playground/validator](https://github.com/go-playground/validator)
  - [example test code is here](https://github.com/d-enk/go-yaml/blob/45889c98b0a0967240eb595a1bd6896e2f575106/testdata/validate_test.go#L12)
...
- https://github.com/d-enk/go-yaml/wiki/Users

The source data is [here](https://github.com/d-enk/go-yaml/network/dependents). 
...
```sh
go get github.com/d-enk/go-yaml
```
...
```sh
git clone https://github.com/d-enk/go-yaml.git
